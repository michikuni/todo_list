...
import 'package:todo_list/data/datasources/interceptor/token_interceptor.dart'
    as _i597;
import 'package:todo_list/data/datasources/local/hive/todo.dart' as _i301;
import 'package:todo_list/data/datasources/local/hive/todo_impl.dart' as _i1072;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i435.GetTodoUseCase>(
        () => _i435.GetTodoUseCase(gh<_i1022.ITodoRepository>()));
    gh.lazySingleton<_i435.AddTodoUseCase>(
        () => _i435.AddTodoUseCase(gh<_i1022.ITodoRepository>()));
    gh.lazySingleton<_i435.UpdateTodoUseCase>(
